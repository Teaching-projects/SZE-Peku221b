...
\subsection{Movies példa bináris mátrixszal}
   ...
   \end{equation}
	...
	\Abra{output_minizinc}{}{width=14cm}
...
\subsection{Fundraising Dinner példa változó tömbökkel}
    ...
    \Abra{array_declaration}{}{width=7cm}
   ...
   \begin{equation} \label{eq:14}
    ...
    \Abra{count2}{}{width=14cm}
    
    \Abra{count3}{}{width=14cm}
...
\chapter{Redundáns megkötések megkeresése}
    ...
    \Abra{code_generator}{}{width=16cm}
