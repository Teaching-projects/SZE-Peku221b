...
\subsection{Termény halmazok}
    ...
    $$ \forall k \in Kertek: \left\| Termeszt_k \right\| =3 $$
...
\subsection{Integer mátrix}
   ...
   %kód
    ...
    $$ \forall k \in Kertek, n \in 1,\dots,Noveny : termeszt[k,n] < tulaj[k,n+1] $$
...
\subsection{Movies példa bináris mátrixszal}
    ...
    $$ \forall szek\in 2..db : movie[thriller,szek]=1 \Leftrightarrow shirt[black,szek]=1 $$
...
\subsection{Fundraising Dinner példa változó tömbökkel}
	...
	$$ \forall p \in 1..db-1 : cocktail[p]=cosmopolitan \leftrightarrow age[p+1]=sixty$$ 
	$$ \wedge cocktail[db] != cosmopolitan \wedge age[1] \neq sixty $$
    ...
    %kód
    $$ \forall a,b \in People \wedge a<b : \neg(cocktail[a] =margarita \wedge dress[b]=blue) $$
    ...
    $$ \forall p \in 2..db-1: (name[p]=Lidia \rightarrow (cocktail[p-1]=cosmopolitan \oplus cocktail[p+1]=cosmopolitan)) \wedge $$
    	$$\forall p \in 2..db-1 : (cocktail[p]=cosmopolitan \rightarrow (name[p-1]=Lidia \oplus name[p+1]=Lidia)) \wedge$$
    	$$(name[1]=Lidia \rightarrow cocktail[2]=cosmopolitan) \wedge$$
    	$$(name[db]=Lidia \rightarrow cocktail[db-1]=cosmopolitan) \wedge$$
    	$$(cocktail[1]= cosmopolitan \rightarrow name[Lidia]) \wedge$$
    	$$(cocktail[db]=cosmopolitan \rightarrow name[db-1]=Lidia) $$
