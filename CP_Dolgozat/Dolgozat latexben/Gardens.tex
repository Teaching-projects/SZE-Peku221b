...
\subsection{Tulaj hozzárendelési mátrix}
    ...
    Az új mátrix szintén egyesekkel és nullákkal lett feltöltve, ahogy \aref{tulaj_matrix}. táblázatban látható.
...
\chapter{Redundáns megkötések megkeresése}
    ...
    \Abra{futasido3}{Óriás példa futásidejei a különböző modellek esetében}{width=14cm}
