...
\chapter{Empírikus vizsgálatok} % Máté
	...
	\Aref{fig_test-example} ábra demonstrálja, hogyan is néz ki egy generáció: a feladványban szereplő tulajdonságok rendezetten fel vannak sorolva.
	...
	\Abra{test-example}{Példa egy generációra}{width=14cm}
	...
	\Aref{fig_results} ábra mutatja be, hogy miként változik meg a futási sebesség, ha esetenként megváltoztatjuk a populáció és a megtartott egyedek számát.
